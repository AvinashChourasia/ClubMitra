// Event calendar — the Events tab: real upcoming races, synced from the
// MarathonMitra website's public events API. Cards lead with the event banner;
// filter by your city and by distance (the runner's first question: "do they
// have my distance?"); mark yourself going, add to the phone calendar, and tap
// through to the event page for full details + registration.
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bgSecondary }} edges={["top"]}>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16, gap: 12, backgroundColor: colors.bgSecondary }}>
        {/* Header — a top-level tab now, so no back button */}
        <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 24, fontWeight: "800", color: colors.text }}>Event calendar</Text>
